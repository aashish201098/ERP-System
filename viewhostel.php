...
<body>
	...
	<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="studentprofileadminupdate.php">Update UpdateStudent Details</a></li>        </ul>
      </li>
	...
	<h2><center>View and Update Hostel Details</center></h2>

	<form class="form-horizontal" action="viewhostel.php" method="post">
		<div class="form-group">
			<label class="control-label col-sm-2" for='hostelid'>Select Hostel: </label>
			<div class="col-sm-2">
			<select class="form-control" name="hostelid" required="required">
			    ...
			    <option value="<?php echo $row['hostelid'] ?>"><?php echo $row['hostelid'].' '.$row['name'];?> </option>
	...
	<?php 
		if(isset($_POST['view'])){
			include 'db.php';
			$usr = $_POST['hostelid'];
			$sql = "select * from hostel where hostelid = '$usr'";
			$result = mysqli_query($conn,$sql);
			while($row = mysqli_fetch_array($result)){
	 ?>
	...
	<div class="form-group">
	    <label class="control-label col-sm-2" for="id">Hostel ID:</label>
	    <div class="col-sm-4">
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
	    <label class="control-label col-sm-2" for="nor">Number of Rooms:</label>
	    <div class="col-sm-4">
	      <input type="text" class="form-control" name="nor" value="<?php echo $row['totalroom']; ?>" required="required">
	    </div>
	  </div>
	  
	   <div class="form-group">
	    <label class="control-label col-sm-2" for="warden"> Warden:</label>
	    <div class="col-sm-4">
	      <input type="text" class="form-control" name="warden" value="<?php echo $row['warden']; ?>" required="required">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="text" class="form-control" name="phone" value="<?php echo $row['contact']; ?>" required="required">
	    </div>
	  </div>

	  <div class="form-group">
	    <label class="control-label col-sm-2" for="number">Occupied Rooms:</label>
	    <div class="col-sm-4">
	      <input type="Number" class="form-control" name="noor" value="<?php echo $row['occupiedrooms']; ?>" required="required">
	    </div>
	  </div>
	  <?php } ?>
	  <div class="form-group"> 
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$phone = $_POST['phone'];
		$noor = $_POST['noor'];
		$sql = "update hostel set name = '$name' where hostelid = '$usr';";
		$sql .= "update hostel set totalroom = '$nor' where hostelid = '$usr';";
		$sql .= "update hostel set warden = '$warden' where hostelid = '$usr';";
		$sql .= "update hostel set contact = '$phone' where hostelid = '$usr';";
		$sql .= "update hostel set occupiedrooms = '$noor' where hostelid = '$usr'";
