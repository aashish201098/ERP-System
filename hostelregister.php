...
<body>
	...
	<h2><center>Hostel Registration Form</center></h2>
	<form class="form-horizontal" action="hostelregister.php" method="post">
	  <div class="form-group">
	    <label class="control-label col-sm-2" for="name">Name:</label>
	    <div class="col-sm-4">
	      <input type="name" class="form-control" name="name" placeholder="Enter Hostel Name" required="required">
	    </div>
	  </div>
	   ...
	   <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="Number" class="form-control" name="nor" placeholder="Enter Number of Rooms" required="required">
	    </div>
	  </div>
	   ...
	   <div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input type="name" class="form-control" name="warden" placeholder="Enter Warden Name" required="required">
	    </div>
	  </div>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$warden = $_POST['warden'];
		$phone = $_POST['phone'];
		$sql = "insert into hostel(name,totalroom,warden,contact) values('$name','$nor','$warden','$phone')";
		if(mysqli_query($conn,$sql)){
			echo '<script> alert("Hostel Registration Successful."); </script>';
		}else{
